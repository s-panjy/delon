...
@Component({
    ...
    <sf-item-wrap [id]="id" [schema]="schema" [ui]="ui" [showError]="showError" [error]="error" [showTitle]="schema.title">
        ...
        <ng-container [ngSwitch]="type">
            <ng-container *ngSwitchCase="addon">
                <nz-input-group
            ...
            <ng-container *ngSwitchDefault><ng-template [ngTemplateOutlet]="ipt"></ng-template></ng-container>
        </ng-container>
    </sf-item-wrap>
    `,
...
export class StringWidget extends ControlWidget implements OnInit {
    ...
    ngOnInit(): void {
        this.type = !!(
            this.ui.addOnAfter || this.ui.addOnBefore || this.ui.addOnAfterIcon || this.ui.addOnBeforeIcon ||
            this.ui.prefix || this.ui.prefixIcon || this.ui.suffix || this.ui.suffixIcon
        ) ? 'addon' : '';
    }
}
